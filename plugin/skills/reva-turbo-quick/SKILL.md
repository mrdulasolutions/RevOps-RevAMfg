...
|-------------|-----------|-------------------|
| `quote` | `/reva-turbo:reva-turbo-rfq-quote` | Customer, part, qty, material, finish, partner, margin |
| `reorder` | `/reva-turbo:reva-turbo-order-track` | All fields from previous order, updated dates |
| `track` | `/reva-turbo:reva-turbo-china-track` | PO number, current milestones |
| `status` | `/reva-turbo:reva-turbo-dashboard` | Customer filter applied |
| `send update` | `/reva-turbo:reva-turbo-customer-comms` | Customer, order status, milestone data |
| `inspect` | `/reva-turbo:reva-turbo-inspect` | PO number, specs, inspection checklist |
| `ncr` | `/reva-turbo:reva-turbo-ncr` | PO number, part, partner, defect description |
| `scorecard` | `/reva-turbo:reva-turbo-partner-scorecard` | Partner name, performance data |
| `escalate` | `/reva-turbo:reva-turbo-escalate` | PO number, order context, reason |
| `dashboard` | `/reva-turbo:reva-turbo-dashboard` | PM workload view |
| `profile` | `/reva-turbo:reva-turbo-customer-profile` | Customer name, all profile data |
| `remind` | `/reva-turbo:reva-turbo-reminder` | Order, date, message |
| `report` | `/reva-turbo:reva-turbo-report` | Report type, customer/order scope |
| `package` | `/reva-turbo:reva-turbo-china-package` | Order, partner, shipping specs |
| `logistics` | `/reva-turbo:reva-turbo-logistics` | Order, shipping method, destination |
| `qualify` | `/reva-turbo:reva-turbo-rfq-qualify` | RFQ data, customer, capabilities match |
| `gate` | `/reva-turbo:reva-turbo-quality-gate` | Order, stage, checklist |
| `audit` | `/reva-turbo:reva-turbo-audit-trail` | Reference ID, date range |
| `profit` | `/reva-turbo:reva-turbo-profit` | Order or customer scope |
| `pulse` | `/reva-turbo:reva-turbo-pulse` | Dashboard scope |
