# reva-turbo-export-compliance — Export Compliance Gate
...
```
/reva-turbo-export-compliance
```

Automatically triggered by the orchestrator before `reva-turbo-china-package` and before international shipments in `reva-turbo-logistics`.
