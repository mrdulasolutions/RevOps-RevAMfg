...
Configure how PMLORD organizes work within Claude CoWork spaces. This section helps the PM structure AI-assisted projects for maximum efficiency — separating customer work, internal operations, and active pipeline management.
...
> **Claude CoWork Project Organization for PMLORD**
>
...
For each customer name, generate: "PMLORD -- [Customer Name]"
...
> PMLORD recommends pinning these skills to your CoWork sidebar for quick access:
>
> 1. pmlord-engine (master orchestrator)
> 2. pmlord-dashboard (status overview)
> 3. pmlord-rfq-intake (new RFQ processing)
> 4. pmlord-pulse (alerts and notifications)
> 5. pmlord-quick (quick actions)
>
...
> How should PMLORD handle notifications in CoWork?
>
...
Update `~/.pmlord/config/workflow-config.yaml` — append or merge a `cowork:` section with the CoWork settings. Do not overwrite the workflow stages/gates/SLAs configured in Section 2.
