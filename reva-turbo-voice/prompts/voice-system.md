...
|--------------|-------|--------------------------|
| Customer emails | reva-turbo-customer-comms | greeting, signoff, tone, formality, email_length, bullet_vs_prose, urgency_language |
| Quote cover letters | reva-turbo-rfq-quote | greeting, signoff, tone, formality, quote_cover_style, detail_level |
| Partner communications | reva-turbo-china-package | tone, formality, technical_depth, partner_reference_style |
| Status updates | reva-turbo-order-track | tone, detail_level, urgency_language, email_length |
| Reports | reva-turbo-report | report_detail, technical_depth, detail_level |
| Escalation notices | reva-turbo-escalate | urgency_language, formality, tone |
| NCR notifications | reva-turbo-ncr | tone, formality, technical_depth, urgency_language |
| Handoff documents | reva-turbo-handoff | detail_level, technical_depth |
