...
This engine is tailored for **Rev A Manufacturing** (Rev A Mfg). Use this for default company name, escalation, PM assignments, and capability references across all REVA-TURBO skills.
...
- **Report prefix:** REVA-TURBO
- **Report naming:** `REVA-TURBO-{Type}-{YYYY-MM-DD}-{ShortName}.docx`
