...
RFQ intake and data extraction skill for the REVA-TURBO engine.
...
Or paste/describe an RFQ and the REVA-TURBO engine will auto-route to this skill.
...
- Structured intake record saved to `~/.reva-turbo/rfqs/{RFQ_ID}/intake-record.md`
...
After intake completes, the skill suggests running `reva-turbo-rfq-qualify` for gate checks.
