...
- **Time:** Morning (when PM starts PMLORD)
- **Skill Triggered:** `pmlord-order-track`
...
- **Cadence:** Every business day
- **Time:** Morning
- **Skill Triggered:** `pmlord-reminder`
...
- **Cadence:** Every business day
- **Time:** Morning
- **Skill Triggered:** `pmlord-escalate`
...
- **Skill Triggered:** `pmlord-partner-scorecard` (or `pmlord-customer-comms`)
- **Action:**
...
- **Skill Triggered:** `pmlord-partner-scorecard`
- **Action:**
...
5. **Log format:**
   ```json
   {"ts":"2026-03-30T14:00:00Z","task":"daily-order-status","skill":"pmlord-order-track","status":"completed","pm":"Ray Yeh"}
   ```
