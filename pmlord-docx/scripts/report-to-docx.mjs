...
/**
 * PMLORD Report-to-DOCX Converter
 *
 * Converts PMLORD markdown reports to Word .docx format with
    ...
    switch (classified.type) {
      ...
      case "numbered":
        children.push(
          new Paragraph({
            children: parseInlineFormatting(classified.text),
            numbering: { reference: "pmlord-numbering", level: 0 },
            spacing: { before: 40, after: 40 },
          })
        );
        break;
...
async function main() {
  ...
  if (args.length === 0) {
    ...
    console.error("Example: node report-to-docx.mjs PMLORD-WeeklySummary-2026-03-27-RY.md");
    process.exit(1);
  }
