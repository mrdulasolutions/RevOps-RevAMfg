...
|------|---------|-------------|
| `create` | `/reva-turbo:reva-turbo-voice create` | Full 3-phase onboarding |
| `edit` | `/reva-turbo:reva-turbo-voice edit` | Modify specific dimensions |
| `view` | `/reva-turbo:reva-turbo-voice view` | Display current profile |
| `learn` | `/reva-turbo:reva-turbo-voice learn` | Review edit history, suggest updates |
