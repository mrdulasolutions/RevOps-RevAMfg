...
Immediately after incoming inspection (`/reva-turbo-inspect`) is complete.

### Checklist

| # | Check | Critical? | Description |
|---|-------|-----------|-------------|
| 1 | Incoming inspection complete | Yes | `/reva-turbo-inspect` report exists and is finalized |
