...
Multi-PM collaboration and portfolio transfer skill for the REVA-TURBO engine.
...
- Handoff Briefing saved to `~/.reva-turbo/handoffs/{handoff-id}/`
- Return Briefing generated on PM return
- Handoff audit trail at `~/.reva-turbo/state/handoff-log.jsonl`
- Approval decisions at `~/.reva-turbo/state/approval-log.jsonl`
- Alert routing updates at `~/.reva-turbo/state/alert-routing.jsonl`
