...
1. Determine the active PM. Check `~/.pmlord/config.yaml` for the `active_pm` field, or use the PM slug provided by the calling skill.
2. Read `~/.pmlord/users/<pm-slug>/voice-profile.yaml`.
