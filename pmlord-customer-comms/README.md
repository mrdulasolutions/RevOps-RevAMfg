...
Customer communications skill for the PMLORD engine.
...
Can be invoked at any point in the PM workflow when a customer communication is needed. The PMLORD engine auto-suggests this skill after quote generation and shipment events.
...
- Communication logged to `~/.pmlord/comms/comms-log.jsonl`
