# reva-turbo-erp-connector

ERP and inventory integration skill for the REVA-TURBO engine.

## What It Does

Connects REVA-TURBO to ERP and inventory management systems to provide:
...
Or triggered by other REVA-TURBO skills when capacity, cost, or inventory data is needed.
...
ERP type is stored in `~/.reva-turbo/config/erp-config.json`. Data cached at `~/.reva-turbo/erp-data/`.
