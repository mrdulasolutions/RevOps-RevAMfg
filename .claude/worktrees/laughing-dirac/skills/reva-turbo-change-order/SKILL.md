...
Route through `/reva-turbo:reva-turbo-customer-comms` for sending.
...
Route through `/reva-turbo:reva-turbo-customer-comms` (partner mode).
...
|--------|-------------|-------|
| Quote | Revise with new pricing, mark as "Revised" | `/reva-turbo:reva-turbo-rfq-quote` |
| Order | Update specs, timeline, revision level | `/reva-turbo:reva-turbo-order-track` |
| China-track | Adjust milestones per new timeline | `/reva-turbo:reva-turbo-china-track` |
| Inspection | Update checklist with new criteria | `/reva-turbo:reva-turbo-inspect` |
| Logistics | Update shipping plan (weight, dims, dates) | `/reva-turbo:reva-turbo-logistics` |
| Customer profile | Log change order in activity history | `/reva-turbo:reva-turbo-customer-profile` |
| Partner scorecard | Log change event (partner-initiated only) | `/reva-turbo:reva-turbo-partner-scorecard` |
| Audit trail | Full change order record | `/reva-turbo:reva-turbo-audit-trail` |
...
> B) Initiate full re-quote via `/reva-turbo:reva-turbo-rfq-quote`
