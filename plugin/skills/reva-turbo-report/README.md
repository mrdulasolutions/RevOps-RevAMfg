...
Periodic reporting skill for the REVA-TURBO engine.
...
Or ask REVA-TURBO to generate a specific report type.
...
Reports are saved to `~/.reva-turbo/reports/{YEAR}/` and can be converted to .docx using reva-turbo-docx.
