# pmlord-import-compliance — Import Compliance Gate
...
```
/pmlord-import-compliance
```

Automatically triggered by the orchestrator after `pmlord-china-track` (goods shipped) and before `pmlord-logistics` (customs clearance).
