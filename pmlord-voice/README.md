...
Per-user voice and personality tuner for the PMLORD Skills Engine.
...
- Edit history stored at `~/.pmlord/users/<pm-slug>/edit-history.jsonl`

## 4 Modes

| Mode | Command | Description |
|------|---------|-------------|
| `create` | `/pmlord-voice create` | Full 3-phase onboarding |
| `edit` | `/pmlord-voice edit` | Modify specific dimensions |
| `view` | `/pmlord-voice view` | Display current profile |
| `learn` | `/pmlord-voice learn` | Review edit history, suggest updates |
...
- Profiles: `~/.pmlord/users/<pm-slug>/voice-profile.yaml`
- Preferences: `~/.pmlord/users/<pm-slug>/preferences.yaml`
- Edit history: `~/.pmlord/users/<pm-slug>/edit-history.jsonl`
