...
**Traditional PMLORD behavior. Default for new users and new entities.**

- No auto-transitions. Every skill completion suggests the next step but waits for PM confirmation.
- This is how PMLORD works without autopilot.
...
Behavior:
1. Skill completes.
2. PMLORD suggests the next step: "Next recommended: [skill]. Want me to run it?"
