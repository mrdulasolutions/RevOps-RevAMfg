...
> - `/reva-turbo:reva-turbo-customer-profile` -- View or build a profile for this customer
> - `/reva-turbo:reva-turbo-export-compliance` -- Check if this item has export restrictions
> - `/reva-turbo:reva-turbo-china-package` -- Build the specification package to send to your manufacturing partner
