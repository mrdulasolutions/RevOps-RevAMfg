...
Profitability analysis skill for the PMLORD engine.
...
- Profitability Report saved to `~/.pmlord/profit-analysis/{Customer}/`
- Margin Alert (when margin drops below threshold)
- Profit analysis logged to `~/.pmlord/state/workflow-state.jsonl`
...
After analysis, the skill may suggest updating `pmlord-rfq-quote` margin guidelines if systematic quoting errors are detected.
