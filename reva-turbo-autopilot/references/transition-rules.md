...
Complete transition matrix for the REVA-TURBO lifecycle. Each row defines a transition from one skill/stage to the next, whether it should fire automatically, and what conditions must be met.
