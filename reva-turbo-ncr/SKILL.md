...
| Action | Trigger |
|--------|---------|
| Update partner scorecard | Always — run `/reva-turbo-partner-scorecard` |
| Communicate with partner | If rework or RTV — send NCR details via `/reva-turbo-customer-comms` (partner mode) |
| Escalate | If critical or repeat NCR — run `/reva-turbo-escalate` |
