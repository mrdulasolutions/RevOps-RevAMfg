...
**PMLORD Master Orchestrator**

The brain of the PMLORD skills engine. Routes PM requests to the correct sub-skill, chains the RFQ-to-delivery lifecycle, manages workflow state, and coordinates all 40 sub-skills.
...
4. **First-Run Detection** — Detects new installations and triggers `pmlord-setup` onboarding wizard
