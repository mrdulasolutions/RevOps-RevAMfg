...
> - `/pmlord-customer-profile` -- View or build a profile for this customer
> - `/pmlord-export-compliance` -- Check if this item has export restrictions
> - `/pmlord-china-package` -- Build the specification package to send to your manufacturing partner
...
File: ~/.pmlord/state/rfq-pipeline.jsonl
...
1. **Qualify** -- Can Rev A make this part? (/pmlord-rfq-qualify)
2. **Quote** -- Get pricing from your partner (/pmlord-rfq-quote)
3. **Compliance check** -- Any export restrictions? (/pmlord-export-compliance)
