...
PM reminder system skill for the PMLORD engine.
...
Typically triggered automatically by pmlord-cron as part of the daily routine.
...
Reminder history is stored at `~/.pmlord/state/reminder-log.jsonl`.
