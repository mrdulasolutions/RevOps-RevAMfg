...
- id: "LIB-A1"
  ...
  action:
    ...
    blocking: true
  scope: [pmlord-rfq-quote, pmlord-customer-comms]
  priority: 5
  active: true
```
...
- id: "LIB-L1"
  ...
  action:
    ...
    channel: "pulse"
  scope: [pmlord-order-track, pmlord-pulse]
  priority: 15
  active: true
```
...
- id: "LIB-L4"
  ...
  action:
    ...
    channel: "both"
  scope: [pmlord-pulse, pmlord-crm-connector]
  priority: 10
  active: true
```
...
- id: "LIB-R1"
  ...
  scope: [pmlord-rfq-qualify, pmlord-china-package]
  priority: 20
  active: true
```
...
- id: "LIB-Q1"
  ...
  scope: [pmlord-inspect, pmlord-quality-gate]
  priority: 15
  active: true
```
...
- id: "LIB-W1"
  ...
  scope: [pmlord-order-track, pmlord-inspect]
  priority: 20
  active: true
```
...
- id: "LIB-W2"
  ...
  scope: [pmlord-order-track, pmlord-repackage]
  priority: 25
  active: true
```
...
- id: "LIB-W3"
  ...
  scope: [pmlord-rfq-qualify, pmlord-rfq-quote]
  priority: 15
  active: true
```
...
- id: "LIB-C1"
  ...
  scope: [pmlord-repackage, pmlord-logistics]
  priority: 10
  active: true
```
...
- id: "LIB-C3"
  ...
  action:
    ...
    blocking: true
  scope: [pmlord-rfq-quote, pmlord-order-track]
  priority: 3
  active: true
```
