...
Complete reference for all PMLORD quick actions. Each entry includes syntax, examples, what gets pre-filled, what requires confirmation, and which skill is invoked.
...
**Routes to:** `/pmlord-rfq-quote` (new quote) then `/pmlord-order-track` (new order)
...
**Routes to:** `/pmlord-dashboard` (filtered by customer)
...
**Routes to:** `/pmlord-customer-comms`
...
**Routes to:** `/pmlord-partner-scorecard`
...
**Routes to:** `/pmlord-customer-profile`
...
**Routes to:** `/pmlord-china-package`
