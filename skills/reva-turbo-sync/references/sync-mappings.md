...
Complete bidirectional field mappings between REVA-TURBO and external systems.

---

## REVA-TURBO Order Stage to CRM Deal Stage

### HubSpot Mapping

| REVA-TURBO Order Stage | HubSpot Deal Stage | HubSpot Pipeline |
|-------------------|-------------------|-----------------|
...
| REVA-TURBO Order Stage | Dynamics Opportunity Stage | Status Reason |
|-------------------|--------------------------|---------------|
...
## REVA-TURBO Customer Profile to CRM Account/Contact

### Outbound (REVA-TURBO to CRM)

| REVA-TURBO Field | CRM Field | Sync Direction | Notes |
|-------------|-----------|---------------|-------|
...
| total_orders | Custom: Total Orders | REVA-TURBO primary | |
| total_revenue | Custom: Lifetime Revenue | REVA-TURBO primary | |
| last_order_date | Custom: Last Order Date | REVA-TURBO primary | |
| preferred_partner | Custom: Preferred Partner | REVA-TURBO primary | |
| quality_score | Custom: Quality Score | REVA-TURBO primary | |

### Inbound (CRM to REVA-TURBO)

| CRM Field | REVA-TURBO Field | Auto-Sync? | Notes |
|-----------|-------------|-----------|-------|
...
## Email Subject Patterns to REVA-TURBO Entity Matching
...
## REVA-TURBO Activity to CRM Activity Log

| REVA-TURBO Event | CRM Activity Type | CRM Activity Subject |
|-------------|-------------------|---------------------|
