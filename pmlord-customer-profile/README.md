# pmlord-customer-profile

Customer profile management skill for the PMLORD engine.
...
- Customer profile document saved to `~/.pmlord/customers/{CUSTOMER_ID}/profile.md`
