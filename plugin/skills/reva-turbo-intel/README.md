...
Predictive analytics and business intelligence for the REVA-TURBO engine.

## What It Does

Reads all REVA-TURBO historical data (JSONL logs, scorecards, audit trails, inspection records, NCRs) and generates forward-looking intelligence. Five analysis modes turn raw data into actionable advice.
...
Or ask any analytical question and the REVA-TURBO engine routes to Intel.
...
- Intel reports saved to `~/.reva-turbo/analytics/intel-outputs.jsonl`
