...
Quote generation skill for the PMLORD engine.
...
Typically runs after `pmlord-rfq-qualify` produces a PROCEED or CONDITIONAL decision.

## Inputs

- Qualified RFQ data (from `pmlord-rfq-qualify`)
...
- Quote package saved to `~/.pmlord/rfqs/{RFQ_ID}/quote-package.md`
...
After the quote is generated, the skill suggests running `pmlord-customer-comms` to draft a quote submission email.
